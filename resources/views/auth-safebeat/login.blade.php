            ...
            <div class="block block-themed animated fadeIn">
                <div class="block-header bg-primary">
                    <ul class="block-options">
                        <li>
                            <a href="{!! url('forgot-password') !!}" title="Recover Password"><i class="si si-wrench"></i> Forgot Password?</a>
                        </li>
                        <li>
                            <a href="{!! url('register') !!}" title="Register"><i class="si si-plus"></i> Register</a>
                        </li>
                    </ul>
                ...
                <div class="block-content block-content-full block-content-narrow">
                    ...
                    @endif
                     ...
                     <form class="js-validation-login form-horizontal push-50-t push-50" action="{!! url('login') !!}" method="post">
                        {!! csrf_field() !!}
