            ...
            <div class="block-content">
                ...
                <div class="block-content block-content-full">
                    {!! Form::open([
                        ...
                        'url' => route('projectsEdit')
                        ])
                    !!}
                    {!! Form::hidden('projectsId', $project->projectsId) !!}
                    {!! Form::hidden('currentImage', $project->image) !!}
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('title', 'Title *') !!}
                                {!! Form::text('title', $project->title, ['class'=>'form-control', 'id'=>'title', 'maxlength'=>50]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                <div class="boxSelectTypes">{!! Form::select('projectsTypeId', $projectsType, $project->projectsTypeId, ['id' => 'projectsTypeId', 'class' => 'form-control', 'style' => 'width:80%; float:left;']) !!}</div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('projectDate', $project->projectDate->format('m/d/Y'), ['class'=>'js-datepicker js-masked-date form-control', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy',
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('client', $project->client, ['class'=>'form-control', 'id'=>'client', 'maxlength'=>50]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('agency', $project->agency, ['class'=>'form-control', 'id'=>'agency', 'maxlength'=>50]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                {!! Form::label('url', 'URL') !!}
                                {!! Form::text('url', $project->url, ['class'=>'form-control', 'id'=>'url', 'placeholder'=>'Without http://', 'maxlength'=>255]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::textarea('tags', $project->tags, ['class'=>'js-tags-input form-control', 'rows' => '6', 'id'=>'tags']) !!}
                            </div>
                        </div>
                    </div>
                    <br /><br />
                    <div class="form-group largeImage">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="img-current">
                                <img src="{!! url($imageDetails['folder'].$project->projectsId.'/large_'.$project->image."?".time()) !!}" alt="{{ $project->title }}" />
                            </div>
                            ...
                            <label class="btn btn-success btn-xs btn-upload" for="largeImage" title="Select Image">
                                ...
                                {!! Form::file('largeImage', ['class'=>'sr-only', 'id'=>'largeImage', 'accept'=>'image/*', 'data-crop'=>true]) !!}
                    ...
                    <div class="form-group mediumImage">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="img-current">
                                <img src="{!! url($imageDetails['folder'].$project->projectsId.'/medium_'.$project->image."?".time()) !!}" alt="{{ $project->title }}" />
                            </div>
                            ...
                            <label class="btn btn-success btn-xs btn-upload" for="mediumImage" title="Select Image">
                                ...
                                {!! Form::file('mediumImage', ['class'=>'sr-only', 'id'=>'mediumImage', 'accept'=>'image/*', 'data-crop'=>true]) !!}
                                <span class="docs-tooltip" title="Select Image">Select Image</span>
                            </label>
                            <label class="btn btn-success btn-xs btn-cancel-upload hidden" title="Cancel">Cancel</label>
                        </div>
                    ...
                    <div class="form-group smallImage">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="img-current">
                                <img src="{!! url($imageDetails['folder'].$project->projectsId.'/small_'.$project->image."?".time()) !!}" alt="{{ $project->title }}" />
                            </div>
                            ...
                            <label class="btn btn-success btn-xs btn-upload" for="smallImage" title="Select Image">
                                ...
                                {!! Form::file('smallImage', ['class'=>'sr-only', 'id'=>'smallImage', 'accept'=>'image/*', 'data-crop'=>true]) !!}
                                <span class="docs-tooltip" title="Select Image">Select Image</span>
                            </label>
                            <label class="btn btn-success btn-xs btn-cancel-upload hidden" title="Cancel">Cancel</label>
                        </div>
