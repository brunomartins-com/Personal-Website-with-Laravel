...
@section('title', 'Order Projects Movie | ')
                ...
                <div class="block-content block-content-full">
                    ...
                    <div class="row js-draggable-items">
                        <div class="col-sm-12 draggable-column">
                            ...
                            !!}
                            {!! Form::hidden('databaseTable', 'projectsMovie') !!}
                            {!! Form::hidden('primaryKey', 'projectsMovieId') !!}
                            {!! Form::hidden('sortorder', '') !!}
                            @foreach($movies as $movie)
                            <!-- Block -->
                            <div class="block draggable-item" title="{{ $movie->projectsMovieId }}">
                                <div class="block-header">
                                    ...
                                    <h3 class="block-title">
                                        <img src="{{ $movie->image }}" height="100" alt="{{ $movie->label }}" />
                                    </h3>
                                </div>
                            </div>
                            <!-- END Block -->
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 push-30-t">
                                    {!! Form::button('Done', ['class'=>'btn btn-success btn-back pull-left', 'data-url'=>route('projectsMovie', $project->projectsId)]) !!}
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
