                ...
                <div class="block-content block-content-full">
                    ...
                    <div class="row js-draggable-items">
                        <div class="col-sm-12 draggable-column">
                            ...
                            !!}
                            {!! Form::hidden('databaseTable', 'projects') !!}
                            {!! Form::hidden('primaryKey', 'projectsId') !!}
                            {!! Form::hidden('sortorder', '') !!}
                            @foreach($projects as $project)
                            <!-- Block -->
                            <div class="block draggable-item" title="{{ $project->projectsId }}">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12 push-30-t">
                                    {!! Form::button('Done', ['class'=>'btn btn-success btn-back pull-left', 'data-url'=>route('projects')]) !!}
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
