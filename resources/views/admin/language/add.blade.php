                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::text('languageName', '', ['class'=>'form-control', 'id'=>'name', 'maxlength'=>45]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::select('write', $languageLevels, '', ['id' => 'write', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::select('read', $languageLevels, '', ['id' => 'read', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::select('speak', $languageLevels, '', ['id' => 'speak', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                            <div class="form-input">
                                ...
                                {!! Form::select('listen', $languageLevels, '', ['id' => 'listen', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="fileupload fileupload-new form-input" data-provides="fileupload">
                                <div class="fileupload-new" style="max-width:{{ $imageDetails['flagWidth'] }}px; max-height:{{ $imageDetails['flagHeight'] }};">
                                    <img src="http://placehold.it/{{ $imageDetails['flagWidth'] }}x{{ $imageDetails['flagHeight'] }}" alt="Add Flag" />
                                </div>
