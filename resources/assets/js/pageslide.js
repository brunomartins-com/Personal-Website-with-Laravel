...
(function(b) {
    function j(e, a) {
        if (0 === e.indexOf("#"))
            ...
            $.ajax({
                ...
                type: "GET",
                beforeSend: function(){
                    $(id).addClass('pageslide-loading');
                }
            }).done(function(d){
                $(id).removeClass('pageslide-loading');
                $(id).html(d);
            });
            //c.load(e);
            c.data("localEl", !1)
    ...
    b.fn.pageslide = function(e) {
        this.click(function(a) {
            ...
            window.history.pushState(null, null, d.attr('href'));
        })
    };
    ...
    b.pageslide = function(e) {
        ...
        //c.is(":visible") && c.data("direction") != a.direction ?
        b.pageslide.close(function() {
            j(a.href, a.iframe);
